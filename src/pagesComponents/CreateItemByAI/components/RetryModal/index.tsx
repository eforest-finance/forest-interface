...
const RetryModal = (props: RetryModalProps) => {
  ...
  return (
    <Modal
      ...
      closeIcon={false}
      title={
        <div className="justify-between pt-[4px] mdl:pt-[12px] mdl:pl-[8px]  flex items-center font-semibold mdl:text-[24px] text-[20px] mdl:leading-[32px] leading-[28px]">
          Something Wrong
      ...
      footer={
        <div className="mt-[32px] mdl:mt-[56px] flex justify-center items-center mdl:mb-[32px] mb-[4px]">
          ...
          <Button
            type="primary"
            onClick={onRetry}
            className="!ml-[32px] w-[225px] !h-[56px] !rounded-[12px] !text-[16px] !font-semibold  bg-brandNormal  !text-white">
            Retry
          </Button>
        </div>
      }
      ...
      <p className="mdl:mx-[32px] ml-0 mt-[24px] mdl:mt-[56px] text-[18px] font-semibold text-textPrimary leading-[26px]">
        ...
        <Link className="text-brandNormal" href={''}>
          Ai generator - Failed orders
        </Link>
        " later and re-initiate the generation of the Ai image.
      </p>
    </Modal>
  );
};
