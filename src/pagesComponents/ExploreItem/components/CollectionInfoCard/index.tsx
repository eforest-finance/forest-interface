  ...
  return (
    <div className="seed__name">
      ...
      <div className="flex items-center">
        ...
        <Copy
          className="copy-svg pl-[4px] cursor-pointer"
...
export function CollectionsInfoCard({
  collectionsInfo,
  showAddNftBtn,
}: {
  collectionsInfo?: INftCollectionInfo;
  showAddNftBtn?: boolean;
}) {
  const { isLG } = useResponsive();
  return (
    <>
          ...
          <Button type="primary" className="!w-[140px]" size="large">
            <Link
              href={{
                ...
                query: { collectionId: collectionsInfo?.id },
              }}>
              Add item
            </Link>
          </Button>
