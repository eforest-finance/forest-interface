      ...
      <div className="p-[16px] pt-0 lg:p-[24px] lg:pt-0">
        <p>
          ...
          <Tooltip title={nftInfo?.nftSymbol}>
            <span className="font-medium text-[16px] text-textPrimary max-w-[176px] lg:max-w-[200px]">
        ...
        <p>
          <span>Network</span>
          <span className="font-medium text-[16px] text-textPrimary">{nftInfo?.issueChainIdStr || '--'}</span>
        </p>
        <p>
          ...
          {nftInfo?.nftCollection?.baseUrl ? (
            ...
            <span className="font-medium text-[16px] text-textPrimary">--</span>
          )}
        </p>
        <p>
