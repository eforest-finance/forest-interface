    ...
    <Modal
      ...
      <div className="flex flex-col items-center px-[24px]">
        ...
        <div className=" text-textSecondary mt-[24px]">
          <ul className="text-left text-[12px] list-disc leading-[20px]">
            <li>Please double-check the information. Each account can only mint once.</li>
            <li>
              by minting the AI NFT, users are granting Forest NFT permission to showcase the nfts on the collection
              page.
            </li>
          </ul>
        </div>
  ...
  return (
    <Modal
      ...
      <div className="w-full h-full flex flex-col items-center relative">
        ...
        <Button
          className="!flex justify-center items-center mt-[24px] w-full h-[48px]  "
          type="primary"
          onClick={handleShare}>
          <X className="mr-[8px]" />
          Share on X!
        ...
        <div className="text-textSecondary text-center mt-[8px]">
          Stand a chance to win 50 $ELF by sharing your NFT on X！
        </div>
      </div>
    </Modal>
  );
