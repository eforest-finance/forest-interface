        ...
        {isSmallScreen ? (
          <div className="flex justify-center items-center flex-col	text-left ">
            <div className="flex justify-center items-center">
              ...
              <p className="flex-1 text-[16px] leading-[24px] font-medium">{title}</p>
            </div>
            <div>
              <p className="ant-upload-hint !mt-[16px] text-[14px]">{subTitle}</p>
            </div>
          </div>
        ) : (
          <div className="flex justify-center items-center">
            ...
            <div className="text-left flex-1">
              <p className="text-[16px] leading-[24px] font-medium">{title}</p>
              <p className="ant-upload-hint !mt-[16px] text-[14px]">{subTitle}</p>
            </div>
          </div>
        )}
